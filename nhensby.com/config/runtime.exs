...
if System.get_env("PHX_SERVER") do
  config :nhensby, NhensbyWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  host = System.get_env("PHX_HOST") || "nhensby.com"
  port = String.to_integer(System.get_env("PORT") || "4000")

  config :nhensby, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
